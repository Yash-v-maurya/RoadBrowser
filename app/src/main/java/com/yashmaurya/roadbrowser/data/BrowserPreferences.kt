...
object BrowserPreferences {
    ...
    fun isYouTubeCompatEnabled(context: Context): Boolean {
        return context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .getBoolean(KEY_YOUTUBE_COMPAT_ENABLED, true)
    }

    fun setYouTubeCompatEnabled(context: Context, enabled: Boolean) {
        context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
            .putBoolean(KEY_YOUTUBE_COMPAT_ENABLED, enabled)
            .apply()
    }

    fun isBackgroundAudioEnabled(context: Context): Boolean {
        return context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .getBoolean(KEY_BACKGROUND_AUDIO_ENABLED, true)
    }

    fun setBackgroundAudioEnabled(context: Context, enabled: Boolean) {
        context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
            .putBoolean(KEY_BACKGROUND_AUDIO_ENABLED, enabled)
            .apply()
    }

    fun isOpenPopupsInNewTabEnabled(context: Context): Boolean {
        return context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .getBoolean(KEY_OPEN_POPUPS_IN_NEW_TAB_ENABLED, true)
    }

    fun setOpenPopupsInNewTabEnabled(context: Context, enabled: Boolean) {
        context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
